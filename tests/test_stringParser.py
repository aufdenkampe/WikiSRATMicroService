...
class TestStringParser(TestCase):
    ...
    def test_not_json(self):
        with self.assertRaisesRegex(AttributeError, "Expecting property name enclosed in double quotes: line 1 column 2 \(char 1\)"):
            self.sut = StringParser.parse("{test")

    def test_check_no_huc12(self):
        with self.assertRaisesRegex(AttributeError, "9999999999999 is greater than the maximum of 999999999999"):
            self.sut = StringParser.parse(
    ...
    def test_ob_to_string(self):
        self.sut = StringParser.ob_to_string([{'huc12': 20402010101, 'tpload_hp': 10, 'tpload_Crop': 10, 'tpload_Wooded': 10, 'tpload_Open': 10,
                     'tpload_barren': 10, 'tpload_ldm': 10, 'tpload_MDM': 10, 'tpload_HDM': 10, 'tpload_OtherUp': 10,
                     'tpload_FarmAn': 10, 'tpload_tiledrain': 10, 'tpload_streambank': 10, 'tpload_subsurface': 10,
                     'tpload_pointsource': 10, 'tpload_septics': 10, 'tnload_hp': 10, 'tnload_crop': 10,
                     'tnload_wooded': 10, 'tnload_open': 10, 'tnload_barren': 10, 'tnload_ldm': 10, 'tnload_mdm': 10,
                     ...
                     'tssload_barren': 10, 'tssload_ldm': 10, 'tssload_mdm': 10, 'tssload_hdm': 10,
                     'tssload_otherup': 10, 'tssload_tiledrain': 10, 'tssload_streambank': 10}])
        self.assertEqual(self.sut,'[{"huc12": 20402010101, "tpload_hp": 10, "tpload_Crop": 10, "tpload_Wooded": 10, "tpload_Open": 10, "tpload_barren": 10, "tpload_ldm": 10, "tpload_MDM": 10, "tpload_HDM": 10, "tpload_OtherUp": 10, "tpload_FarmAn": 10, "tpload_tiledrain": 10, "tpload_streambank": 10, "tpload_subsurface": 10, "tpload_pointsource": 10, "tpload_septics": 10, "tnload_hp": 10, "tnload_crop": 10, "tnload_wooded": 10, "tnload_open": 10, "tnload_barren": 10, "tnload_ldm": 10, "tnload_mdm": 10, "tnload_hdm": 10, "tnload_otherup": 10, "tnload_farman": 10, "tnload_tiledrain": 10, "tnload_streambank": 10, "tnload_subsurface": 10, "tnload_pointsource": 10, "tnload_septics": 10, "tssload_hp": 10, "tssload_crop": 10, "tssload_wooded": 10, "tssload_open": 10, "tssload_barren": 10, "tssload_ldm": 10, "tssload_mdm": 10, "tssload_hdm": 10, "tssload_otherup": 10, "tssload_tiledrain": 10, "tssload_streambank": 10}]')